...
def optimize_neural_network(X, y, cv=5):
    ...
    best_nn = MLPClassifier(**grid_search.best_params_, max_iter=1000, random_state=42)
...
def main():
    ...
    # Neural Network
    best_nn = optimize_neural_network(X_selected, y)
    best_models['nn'] = best_nn
    nn_results = evaluate_model(best_nn, X_selected, y)
    report_results("Neural Network", nn_results)
